      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <div className="relative z-10">
            ...
            <button onClick={() => window.gtag_report_conversion('tel:+18001234567')} className="bg-white cursor-pointer text-yellow-600 font-bold px-10 py-4 rounded-full hover:bg-gray-100 transition-all transform hover:scale-105 shadow-xl">
              Book Your Train Now
            </button>
